<?php
/**
 * yo theme functions and definitions
 *
...
if ( ! function_exists( 'yo_theme_setup' ) ) :
	...
	function yo_theme_setup() {
		 ...
		 * If you're building a theme based on yo theme, use a find and replace
		 * to change 'yo-theme' to the name of your theme in all the template files.
		 */
		load_theme_textdomain( 'yo-theme', get_template_directory() . '/languages' );
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'yo-theme' ),
		) );
...
function yo_theme_widgets_init() {
	register_sidebar( array(
		...
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'yo-theme' ),
...
function RadTheme_enqueue_styles() {
	...
	wp_enqueue_style( "yo-style", get_template_directory_uri().'/assets/css/yo-style.css', array(), '1.0', 'all' );
...
function yo_theme_scripts() {
	...
	wp_enqueue_script( 'yo-theme-navigation', get_template_directory_uri() . '/assets/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'yo-theme-skip-link-focus-fix', get_template_directory_uri() . '/assets/js/skip-link-focus-fix.js', array(), '20151215', true );
