...
<!-- dshgyufegsyug -->
	...
	<header id="masthead" class="site-header">
		<div class="site-branding">
			...
			$yo_theme_description = get_bloginfo( 'description', 'display' );
			if ( $yo_theme_description || is_customize_preview() ) :
				?>
				<p class="site-description"><?php echo $yo_theme_description; /* WPCS: xss ok. */ ?></p>
			<?php endif; ?>
		</div><!-- .site-branding -->
